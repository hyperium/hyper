...
use hc::{HttpResult};
use hc::version::{HttpVersion};
use hc::method::Method::{mod, Get, Head};
use header::Headers;
use header::common::{ContentLength, TransferEncoding};
use hc::http::{read_request_line};
use hc::http::HttpReader;
use hc::http::HttpReader::{SizedReader, ChunkedReader, EmptyReader};
use hc::uri::RequestUri;
