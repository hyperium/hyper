...
header! {
    ...
    #[doc="headers.set("]
    #[doc="    AcceptCharset(vec![qitem(Charset::UsAscii)])"]
    #[doc=");"]
    #[doc="```"]
    #[doc="```"]
    ...
    #[doc="        QualityItem::new(Charset::UsAscii, Quality(900)),"]
    #[doc="        QualityItem::new(Charset::Iso885910, Quality(200)),"]
    #[doc="    ])"]
    #[doc=");"]
    #[doc="```"]
    #[doc="```"]
    ...
    #[doc="let mut headers = Headers::new();"]
    #[doc="headers.set("]
    #[doc="    AcceptCharset(vec![qitem(Charset::Unregistered(\"utf-8\".to_owned()))])"]
    #[doc=");"]
    #[doc="```"]
